...
/**
 * TODO: Create shadow props for component
 * @param {Number} depth depth of component [1-24]
 * @param {String} color color of shadow (hex value) - default '#000'
 */
export const shadow = (depth, color) => {
    depth--
    color = color ? hexToRgba(color, 1) : hexToRgba('#000', 1)
